...
const Work = ({ theme }) => {
    return(
        <main className="grid place-items-center gap-y-10 font-montserrat w-full h-full px-28 py-20">
            ...
            <section className="grid grid-cols-3 justify-items-center gap-x-10 w-full">
                <div className="w-80 h-96 bg-gradient-to-br from-[#191919] to-[#7F7F7F] rounded-2xl">
            ...
            <section className="w-full h-full bg-gradient-to-r from-[#191919] to-[#7F7F7F] rounded-2xl flex justify-between p-10">
                {projectFiles.Projects.map((project) => (
                    <div key={project.P_id} className="w-[18.5rem] h-80 hover:scale-[1.02] relative group">
                        <img
                            src={project.img}
                            alt="project image"
